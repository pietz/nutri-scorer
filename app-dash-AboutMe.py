...
sidebar = html.Div(
    [
        html.H1("Nutri Scorer", className="display-4"),
        html.Hr(),
        html.P(
...
app.layout = html.Div([
    html.Div([
        ...
        dt.DataTable(
            ...
            style_header={'border':'2px solid black', 'fontWeight':'bold', 'font_size':'23px'},
        )
...
def render_page_content(pathname):
    if pathname == "/single": # THIS IS WHAT HAPPENS ON THE SINGLE PRODUCT PAGE
        ...
        return html.Div(
            [
                html.H1("Custom Product", style={'textAlign':'center', 'fontWeight':'bold'}),
                html.Hr(),html.Hr(),
                html.H3("In this page you can insert the nutrition values of a single product" ,style={'textAlign':'center',}),
                html.H3("and get an estimation for its NutriScore!" ,style={'textAlign':'center',}),
                html.Hr(),
                ...
                html.Hr(),
                html.Div([
                    html.Button('Calculate NutriScore', id='nutriscore-single-button', n_clicks = 0, style={'margin-top':'30px',}),
                ], style = {'textAlign':'center'}),
         ...
         return html.Div([
            ...
            html.H1("Custom Recipe", style={'textAlign':'center', 'fontWeight':'bold'}),
            html.Hr(),html.Hr(),
            html.H3("In this page you can insert many products and get an estimation" ,style={'textAlign':'center',}),
            html.H3("on the total NutriScore of your recipe!" ,style={'textAlign':'center',}),
            html.Hr(),
            html.H3("Instructions", style={'textAlign':'center',}),
            html.H5("1) Upload a photo of a product.", style={'textAlign':'center',}),
            html.H5("2) Make sure that all attributes have a number and are not nan.", style={'textAlign':'center',}),
            html.H5("3) Input the amount of the product in the recipe and click on Add Product.", style={'textAlign':'center',}),
            html.H5("4) Repeat 1-3 until you have all the products you need.", style={'textAlign':'center',}),
            html.H5("5) Click on Calculate NutriScore.", style={'textAlign':'center',}),
            html.Hr(),

            html.H2("Upload a photo of the product", style={'textAlign':'center',}),
            dcc.Upload(
            ...
            html.Hr(),
            html.H2("Recipe Contents"),
            html.Div(id='custom-button-output', children=[]),
            html.Hr(),
            html.H2('Recipe Totals'),
            html.Div([
                html.H5('Recipe Total Grams'),
            ...
            html.Hr(),
            html.Button('Calculate NutriScore', id='nutriscore-button', n_clicks = 0, style={'margin-left':'150px'}),
        ...
        return html.Div(
            [
                html.Div(
                    [
                    html.H1("BMI and Calorie Calculator", style={'textAlign':'center'}),
                 ...
                 html.Div(
                     [
                        ...
                        html.Div(dcc.Input(id='input_age', type='number', placeholder='Age in years', min=1, style={'width': '20%'})),
                    ]),
                html.Div(
                    [
                        html.Hr(),
                ...
                html.Div([
                    ...
                    html.Div(id='output-container-button',
                        children='You need enter all parameters'),
                ]),
                # NEW END
                html.Div([
        ...
        return html.Div([
                ...
                html.Div([
                    dbc.Button('Press 3 times to reset', id="calendar-reset", style={'height':60, 'width':'20%', 'margin-top':'40px'}, n_clicks=0),
                    dbc.Modal(
                        [
        ...
        return html.Div([
            ...
            html.Div([
                html.Button('Add with nutrition values', id='button-nutvalue',  n_clicks=0,
                            style={'display':'inline-block',
                                    'textAlign':'center'}),
                html.Button('Add with product image', id='button-prodimage', n_clicks=0, 
                            style={'display':'inline-block',
                                    'margin-left':'100px'}),
            ...
            html.Hr(),
            html.Div([
                dbc.Button("Add Day", id="add-day", style={'height':60, 'width':'20%', 'margin-top':'100px'}, n_clicks=0),
                dbc.Modal(
                    [
                        #dbc.ModalHeader("Header"),
...
def parse_contents_custom (contents):
    ...
    return html.Div([
        ...
        html.Div([
            html.H6("Amount of grams in recipe"),
            dcc.Input(
                id= 'input-custom',
                placeholder='Enter a value...',
                type='number',
            ...
            html.Button('Add Product', id='custom-button', n_clicks = 0, style={'verticalAlign':'bottom', 'width':200, 'height':40, "margin-top": "15px"}),
...
def button_functionality(n_clicks, value, children, productinfo,currentcal, currentfat, currentsatfat,
    ...
    if (value != '' and n_clicks<2):
        ...
        new_ingredient = html.Div ([
            ...
            html.H5(": " + str(value) + "g in recipe ", style={'display':'inline-block'}),
    ...
    #for value in (kcal, fat, sat_fat, proteins, carbs, fibers, sugars, salt):
        if (kcal is None or fat is None or sat_fat is None or proteins is None or carbs is None or 
            ...
            return html.Div([
                    ...
                    html.Img(src="assets/" + str(Y_test)[2] + ".png", style = {'height':200}),
                ], style = {'textAlign':'center'})
...
# TRY UPDATE CALORIES VALUE WITH X_NEW (but not yet working)
@app.callback(
    dash.dependencies.Output(),
    dash.dependencies.Input(component_id='update_button', component_property='n_clicks'),
    dash.dependencies.Input('cal-output-container', 'children'),
...
def displayClick(btn1, btn2):
    ...
    if 'button-nutvalue' in changed_id:
        msg = html.Div([
                ...
                html.Div([
                    html.Button('Add Product to Day', id='myday-button2', n_clicks=0, style={'margin-top':'40px'}),
                ], style={'textAlign':'center', 'margin-top':'40px'})
        ...
        msg = html.Div([
                ...
                html.Div(id='output-image-myday'),
            ])
    else:
        msg = html.Div([])
    return msg
...
def parse_contents_myday (contents):
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Button('Add Product to Day', id='myday-button', style={'verticalAlign':'bottom', 'width':200, 'height':40, "margin-top": "15px"}),
        ], style = {'width':'30%','display':'inline-block','verticalAlign':'center','textAlign':'center', "margin-top": "100px"}),
