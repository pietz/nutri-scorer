...
sidebar = html.Div(
    [
            ...
            [
                html.Div(
                    [
                        dcc.Markdown(
                            """**N**""",
                            style={"color": "#28B463", "display": "inline-block"},
                        ),
                        dcc.Markdown(
                            ["""**u**"""],
                        ...
                        dcc.Markdown(
                            ["""**t**"""],
                            style={"color": "#F7DC6F", "display": "inline-block"},
                        ),
                        dcc.Markdown(
                            ["""**r**"""],
                            style={"color": "#F39C12", "display": "inline-block"},
                        ),
                        dcc.Markdown(
                            ["""**i**"""],
                            style={"color": "#E74C3C", "display": "inline-block"},
                        ),
                    ],
                    style={
                        "textAlign": "center",
        ...
        html.P(
            "A simple app for your healthy-eating needs",
            className="lead",
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink(
                    "Product Suggestions", href="/page-suggest", active="exact"
                ),
...
def render_page_content(pathname):
    if pathname == "/single":  # THIS IS WHAT HAPPENS ON THE Product Photo PAGE
        return html.Div(
            [  # inside html.Div, we create the layout of the page
                html.Div(
                    [
                        html.H2("Product Photo", style={"font-weight": "bold"}),
                        html.H4(
                            "Nutri Score prediction based on a product photo",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                ...
                html.Div(
                    [
                        ...
                        dbc.Modal(
                            [
                                dbc.ModalHeader(
                                    "Information", style={"margin-left": "35%"}
                                ),
                                dbc.ModalBody(
                                    [
                                        "In this page you can upload a photo of a product and find out its NutriScore."
                                    ]
                                ),
                                dbc.ModalFooter(
                                    dbc.Button(
            ...
            [
                html.Div(
                    [
                        ...
                        html.H4(
                            "Compare the nutrition facts of two products",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On this page, you can upload photos of two products that you would like to compare based on their nutritional information"
                                    ]
                                ),
                                dbc.ModalFooter(
                                    dbc.Button(
            ...
            [
                html.Div(
                    [
                        ...
                        html.H4(
                            "Nutri Score prediction based on product facts",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On this page, you can insert the nutrition values of a single product and get an estimation of its NutriScore."
                                    ]
                                ),
                                dbc.ModalFooter(
                                    dbc.Button(
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                html.H6(
                                    "Saturated Fat/100g", style={"textAlign": "center"}
                                ),
                                dbc.Input(
                                    id="input-sat_fat",
                                    placeholder="Enter a value...",
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.H6(
                                    "Carbohydrates/100g", style={"textAlign": "center"}
                                ),
                                dbc.Input(
                                    id="input-carbs",
                                    placeholder="Enter a value...",
                ...
                html.Div(
                    id="nutriscore-single-button-output", style={"textAlign": "center"}
                ),
                html.Hr(),
                html.H5(
                    "Warning: The NutriScore is only an estimation and might not be correct."
                ),
            ]
        )
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.H4(
                            "Nutri Score prediction for a list of products",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On, this page you can insert as many products as you like and get an estimation on the total NutriScore of e.g. your shopping list.",
                                        html.Br(),
                                        "1) Upload a photo of a product.",
                                        html.Br(),
                                        "2) Input the amount of the product and then click on Add Product",
                                        html.Br(),
                                        "3) Repeat the above steps until you have all the desired products. ",
                                        html.Br(),
                                        "4) Click on Calculate NutriScore.",
                                        html.Br(),
                                    ]
                                ),
                                dbc.ModalFooter(
                ...
                html.Div(
                    id="custom-button-output",
                    children=[],
                    style={"textAlign": "center"},
                ),
                html.Hr(),
                html.H4(
                    "Nutrition facts of your total list of products",
                    style={"textAlign": "center"},
                ),
                html.Div(
                    [
            ...
            html.Div(
                [
                                ...
                                [
                                    ...
                                    dbc.Modal(
                                        [
                                            ...
                                            dbc.ModalBody(
                                                [
                                                    "On this page, you can calculate your BMI and your average daily calorie requirements.",
                                                    html.Br(),
                                                    "Please fill out all of the fields and click on the calculate button. Your info will then be saved on the table at the top of the page.",
                                                    html.Br(),
                    ...
                    html.Div(
                        [
                            html.Div(
                                id="hidden-cal-container", style=hide_style
                            ),  # hidden container for importing the simple Calorie need to PAL Calculation
                            html.Hr(),
                            html.Div(
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    html.Div(
                                        id="hidden-hours-container", style=hide_style
                                    ),  # hidden container for importing the hours a day for piechart
                                ],
                                style={
                                    "width": "49%",
                                    "display": "inline-block",
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.H4(
                            "Product suggestions for healthier alternatives",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On this page, you upload an image of a product.",
                                        html.Br(),
                                        "The information of the product will be displayed. Further a menu with different suggestion criteria appears.",
                                        html.Br(),
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.H4(
                            "Calendar with daily evaluation based on your eating habits",
                            style={"color": "#F2B4B6"},
                        ),
                    ],
                    style={
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On this page, you can create your personalized calendar which is color coded based on your daily eating habits.",
                                        html.Br(),
                                        "In order to add a day to your calendar, please visit the 'New Day' page.",
                                        html.Br(),
                                    ]
                                ),
                                dbc.ModalFooter(
                ...
                html.Div(
                    [
                        dbc.Button(
                            "Press 3 times to reset",
                            id="calendar-reset",
                            style={"height": 60, "margin-top": "40px"},
                            n_clicks=0,
                        ),
                        dbc.Modal(
                            [
                                dbc.ModalBody(
                                    "Your calendar has succesfully been reset."
                                ),
                                dbc.ModalFooter(
                                    dbc.Button(
        ...
        return html.Div(
            [
                dcc.Store(id="productinfo"),
                dcc.Store(id="today-products", storage_type="local", data=[]),
                ...
                html.Div(
                    [
                        html.H2("Your Calendar", style={"font-weight": "bold"}),
                        html.H4(
                            "Daily log of your consumption", style={"color": "#F2B4B6"}
                        ),
                    ],
                    style={
                        "text-align": "left",
                    ...
                    [
                        ...
                        dbc.Modal(
                            [
                                ...
                                dbc.ModalBody(
                                    [
                                        "On, this page you can insert all the products that you have consumed today and then save the day in your calendar.",
                                        html.Br(),
                                        "1) Choose a way to add a product.",
                                        html.Br(),
                                        "2) Fill in the required information.",
                                        html.Br(),
                                        "3) Click on Add Product to Day. ",
                                        html.Br(),
                                        "4) Once you have all the products you want, click on Add Day.",
                                        html.Br(),
                ...
                html.Div(
                    [
                        dbc.Button(
                            "Add with nutrition values",
                            id="button-nutvalue",
                            n_clicks=0,
                            style={"display": "inline-block", "textAlign": "center"},
                        ),
                        dbc.Button(
                            "Add with product image",
                            id="button-prodimage",
                            n_clicks=0,
                ...
                html.Div(
                    [
                        dbc.Button(
                            "Add Day",
                            id="add-day",
                            style={"height": 60, "width": "20%", "margin-top": "40px"},
                            n_clicks=0,
                        ),
                        dbc.Modal(
                            [
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.Img(
                        src="assets/" + row["nutriscore_grade"] + ".png",
            ...
            html.Hr(),
            html.H5(
                "Warning: The NutriScore is estimated and might not be correct.",
...
@app.callback(
    Output("output-image-custom", "children"), Input("upload-image-custom", "contents")
)
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        ...
                        id="current_cal-input",
                        style={"display": "None"},
                    ),
                    html.H5("Protein: " + str(round(row["proteins_100g"], 1)) + "g"),
                    html.Div(
                        row["proteins_100g"],
                        id="current_prot-input",
                        style={"display": "None"},
                    ),
                    html.H5("Carbs: " + str(round(row["carbohydrates_100g"], 1)) + "g"),
                    html.Div(
                        row["carbohydrates_100g"],
                        id="current_carb-input",
                        style={"display": "None"},
                    ),
                    html.H5("Fat: " + str(round(row["fat_100g"], 1)) + "g"),
                    html.Div(
                        row["fat_100g"],
                        id="current_fat-input",
                        style={"display": "None"},
                    ),
                    html.H5("Sugar: " + str(round(row["sugars_100g"], 1)) + "g"),
                    html.Div(
                        row["sugars_100g"],
                        id="current_sugar-input",
                        style={"display": "None"},
                    ),
                    html.H5("Salt: " + str(round(row["salt_100g"], 3)) + "g"),
                    html.Div(
                        row["salt_100g"],
                        id="current_salt-input",
                        style={"display": "None"},
                    ),
                    html.Div(
                        row["fiber_100g"],
                        id="current_fiber-input",
                        style={"display": "None"},
                    ),
                    html.Div(
                        row["saturated-fat_100g"],
                        id="current_sat_fat-input",
                        style={"display": "None"},
                    ),
                    html.Img(
                        src="assets/" + row["nutriscore_grade"] + ".png",
...
@app.callback(
    Output("custom-button-output", "children"),
    Input("custom-button", "n_clicks"),
    State("input-custom", "value"),
    State("custom-button-output", "children"),
    State("productinfo", "data"),
    State("current_cal", "data"),
    State("current_fat", "data"),
    State("current_sat_fat", "data"),
    State("current_prot", "data"),
    State("current_carb", "data"),
    State("current_fiber", "data"),
    State("current_sugar", "data"),
    State("current_salt", "data"),
)
def button_functionality(
    n_clicks,
    value,
    children,
    productinfo,
    ...
    if value != "" and n_clicks < 2:
        ...
        new_ingredient = html.Div(
            [
                ...
                html.Div(
                    currentcal * value / 100,
                    id="total_cal-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentfat * value / 100,
                    id="total_fat-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentsatfat * value / 100,
                    id="total_sat_fat-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentprot * value / 100,
                    id="total_prot-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentcarb * value / 100,
                    id="total_carb-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentfiber * value / 100,
                    id="total_fiber-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentsugar * value / 100,
                    id="total_sugar-input",
                    style={"display": "None"},
                ),
                html.Div(
                    currentsalt * value / 100,
                    id="total_salt-input",
                    style={"display": "None"},
                ),
            ]
...
@app.callback(
    Output("nutriscore-button-output", "children"),
    Input("nutriscore-button", "n_clicks"),
    State("totalgrams", "data"),
    State("total_cal", "data"),
    State("total_fat", "data"),
    State("total_sat_fat", "data"),
    State("total_prot", "data"),
    State("total_carb", "data"),
    State("total_fiber", "data"),
    State("total_sugar", "data"),
    State("total_salt", "data"),
)
def nutriscore_button(
    n_clicks,
    totalgrams,
    totalcal,
    totalfat,
    ...
    if totalgrams is not None:
        ...
        X_test = pd.DataFrame(
            [
                [
                    totalcal * (100 / totalgrams),
                    totalfat * (100 / totalgrams),
                    totalsatfat * (100 / totalgrams),
                    totalprot * (100 / totalgrams),
                    totalcarb * (100 / totalgrams),
                    totalfiber * (100 / totalgrams),
                    totalsugar * (100 / totalgrams),
                    totalsalt * (100 / totalgrams),
                ]
            ],
            columns=list(x_cols),
        )
        ...
        return html.Div(
            [
                ...
                html.Img(
                    src="assets/" + str(Y_test)[2] + ".png", style={"height": 150}
                ),
            ],
            style={"textAlign": "center"},
        )
...
@app.callback(
    Output("productinfo-value", "children"),
...
# Output callback of the above Store
@app.callback(
    Output("totalgrams-value", "children"),
    # Since we use the data prop in an output,
    # we cannot get the initial data on load with the data prop.
    # To counter this, you can use the modified_timestamp
    # as Input and the data as State.
...
for store in (
    ...
    @app.callback(
        Output("{}-value".format(store), "children"),
        # Since we use the data prop in an output,
        # we cannot get the initial data on load with the data prop.
        # To counter this, you can use the modified_timestamp
        # as Input and the data as State.
...
def update_graph(a, b, c, d, e):
    ...
    barchart = px.bar(
        ...
        orientation="h",
        labels={"value": "Grams", "Index": "Ingredients"},
    )
    return barchart
...
@app.callback(
    Output("nutriscore-single-button-output", "children"),
    Input("nutriscore-single-button", "n_clicks"),
    State("input-kcal", "value"),
    State("input-fat", "value"),
    State("input-sat_fat", "value"),
    State("input-proteins", "value"),
    State("input-carbs", "value"),
    State("input-fibers", "value"),
    State("input-sugars", "value"),
    State("input-salt", "value"),
)
def nutriscore_button_single(
    n_clicks, kcal, fat, sat_fat, proteins, carbs, fibers, sugars, salt
):
    ...
    if (
        ...
        X_test = pd.DataFrame(
            [[kcal, fat, sat_fat, proteins, carbs, fibers, sugars, salt]],
            columns=list(x_cols),
        )
        Y_test = pd.DataFrame([["e"]], columns=list("A"))
        loaded_model = joblib.load("assets/finalized_model.sav")
...
for type in ("kcal", "fat", "sat_fat", "proteins", "carbs", "fibers", "sugars", "salt"):

    @app.callback(
        Output("input-{}".format(type), "valid"),
        Output("input-{}".format(type), "invalid"),
        Input("input-{}".format(type), "value"),
...
def update_output_height(input_weight, input_height):
    if input_weight and input_height is not None:
        return (
            "You have selected {} cm".format(input_height),
            "You have selected {} kg".format(input_weight),
        )
    else:
        return None, None
...
def update_cal_output(n_clicks, input_age, input_weight, input_height, sex):
    if input_age and input_weight and input_height and sex is not None:
        if sex == "female":
            x = int(
                655.1 + (9.6 * input_weight) + (1.8 * input_height) - (4.7 * input_age)
            )
            # NEW START
            ...
            return (
                html.Div(
                    [
                        html.Div(
                            "You have a basal metabolic rate of {} kcal calories a day!".format(
                                x
                            )
                        ),
                        # NEW START
                        ...
                        # NEW END
                        html.Div(
                            info, id="store-user-info-input", style={"display": "None"}
                        ),
                        html.Div(info, id="update-all", style={"display": "None"}),
                        html.Hr(),
                        html.P(
                            "If you would like to determine a more precise calorie consumption:"
                        ),
                    ]
                ),
                show_style,
        ...
        if sex == "male":
            x = int(
                66.47 + (13.7 * input_weight) + (5 * input_height) - (6.8 * input_age)
            )
            # NEW START
            y = int(input_weight / ((input_height / 100) ** 2))
            info = [input_weight, input_height, x, 0.75 * input_weight, 30, y]
...
def update_output(n_clicks, sleep, lwork, mwork, hwork, x, info):
    if x is not None:
        if x > 0:
            x_new = int(
                x
                * (sleep * 0.95 + lwork * 1.45 + mwork * 1.7 + hwork * 2.2)
                / (sleep + lwork + mwork + hwork)
            )
            info[2] = x_new
            piechart_values = (
                sleep,
            ...
            return (
                "You are sleeping {} hours a day.".format(sleep),
                "You are light working {} hours a day.".format(lwork),
                "You are medium working {} hours a day.".format(mwork),
                "You are heavy working {} hours a day.".format(hwork),
                html.Div(
                    [
                        html.Div(
                            "You have a basal metabolic rate of {} kcal calories a day!".format(
    ...
    return (
        ...
        "You are medium working {} hours a day.".format(mwork),
        "You are heavy working {} hours a day.".format(hwork),
        html.Div("You have a basal metabolic rate of zero kcal calories a day!"),
        [6, 6, 6, 6],
    )
...
@app.callback(
    Output("store-user-info-value", "children"),
    # Since we use the data prop in an output,
    # we cannot get the initial data on load with the data prop.
    # To counter this, you can use the modified_timestamp
    # as Input and the data as State.
...
def refresh_cal(children, data):
    if children is None:
        data1 = [
            {
                "Weight (kg)": data[0],
                "Height (cm)": data[1],
                "Cals/day (Kcal)": data[2],
                "Proteins/day (g)": data[3],
                "Sugar/day (g)": data[4],
                "BMI (score)": data[5],
            }
        ]
        ...
        data1 = [
            {
                "Weight (kg)": children[0],
                "Height (cm)": children[1],
                "Cals/day (Kcal)": children[2],
                "Proteins/day (g)": children[3],
                "Sugar/day (g)": children[4],
                "BMI (score)": children[5],
            }
        ]
    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.H5(
                        "Please select suggestion criteria:",
                        style={"fontWeight": "bold", "font-style": "italic"},
                    ),
                    dbc.DropdownMenu(
                        label="Calories",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Calories-less"),
                            dbc.DropdownMenuItem("More", id="btn-Calories-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
                    ...
                    dbc.DropdownMenu(
                        label="Protein",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Protein-less"),
                            dbc.DropdownMenuItem("More", id="btn-Protein-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
                    ...
                    dbc.DropdownMenu(
                        label="Carbs",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Carbs-less"),
                            dbc.DropdownMenuItem("More", id="btn-Carbs-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
                    ...
                    dbc.DropdownMenu(
                        label="Fat",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Fat-less"),
                            dbc.DropdownMenuItem("More", id="btn-Fat-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
                    ...
                    dbc.DropdownMenu(
                        label="Sugar",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Sugar-less"),
                            dbc.DropdownMenuItem("More", id="btn-Sugar-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
                    ...
                    dbc.DropdownMenu(
                        label="Salt",
                        children=[
                            dbc.DropdownMenuItem("Less", id="btn-Salt-less"),
                            dbc.DropdownMenuItem("More", id="btn-Salt-more"),
                        ],
                        style={
                            "margin": "20px",
                            "width": "100px",
...
@app.callback(
    Output("output-image-upload-suggest", "children"),
        ...
        if math.isnan(res):
            objects.append(
                html.Div(
                    [
                        html.H3(
                            "!  The value is empty. Please select other suggestion criteria"
                        )
                    ],
                    style={"color": "#FF0000"},
                )
                ...
                newone = dbc.Card(
                    [
                        ...
                        dbc.CardBody(
                            [
                                html.H4(
                                    str(iris2.meta.loc[n, "brands"])
                                    + " - "
                                    + str(iris2.meta.loc[n, "product_name"]),
                                ...
                                html.P(
                                    [
                                        ...
                                        + str(
                                            round(
                                                iris2.meta.loc[n, "energy-kcal_100g"], 1
                                            )
                                        ),
                                        html.Br(),
                                        "Proteins:"
                                        + str(
                                            round(iris2.meta.loc[n, "proteins_100g"], 1)
                                        )
                                        + "g",
                                        html.Br(),
                                        "Carbs: "
                                        + str(
                                            round(
                                                iris2.meta.loc[n, "carbohydrates_100g"],
                                                1,
                                            )
                                        )
                                        + "g",
                                        html.Br(),
                                        "Fat: "
                                        + str(round(iris2.meta.loc[n, "fat_100g"], 1))
                                        + "g",
                                        html.Br(),
                                        "Sugar: "
                                        + str(
                                            round(iris2.meta.loc[n, "sugars_100g"], 1)
                                        )
                                        + "g",
                                        html.Br(),
                                        "Salt: "
                                        + str(round(iris2.meta.loc[n, "salt_100g"], 3))
                                        + "g",
                                        html.Br(),
                                        html.Hr(),
                                        dcc.Markdown("""**Keywords: **"""),
                                        str(common)[1:-1],
                                    ],
                                    className="card-text",
                                ),
        ...
        if no_results == 2:
            objects.append(
                html.Div(
                    [
                        html.H3(
                            "!  No products were found matching this category. Please select another product."
                        )
                    ],
                    style={"color": "#FF0000"},
                )
...
@app.callback(
    ...
    Input("btn-Calories-less", "n_clicks"),
    Input("btn-Calories-more", "n_clicks"),
    Input("btn-Protein-less", "n_clicks"),
    Input("btn-Protein-more", "n_clicks"),
    Input("btn-Carbs-less", "n_clicks"),
    Input("btn-Carbs-more", "n_clicks"),
    Input("btn-Fat-less", "n_clicks"),
    Input("btn-Fat-more", "n_clicks"),
    Input("btn-Sugar-less", "n_clicks"),
    Input("btn-Sugar-more", "n_clicks"),
    Input("btn-Salt-less", "n_clicks"),
    Input("btn-Salt-more", "n_clicks"),
    State("sug_id", "data"),
    prevent_initial_call=True,
)
def displayClick(
    ...
    ch = html.Div(
        [
            html.H5("Similar products with ", style={"display": "inline-block"}),
            html.H5(
                str(nn),
                style={
                    "display": "inline-block",
...
@app.callback(
    Output("sug_id", "data"), Input("sug_id_input", "children"), State("sug_id", "data")
)
...
@app.callback(
    Output("store-calendar", "clear_data"), Input("calendar-reset", "n_clicks")
)
...
@app.callback(
    Output("day-remove-output", "children"),
...
@app.callback(
    Output("store-calendar-value", "children"),
    # Since we use the data prop in an output,
    # we cannot get the initial data on load with the data prop.
    # To counter this, you can use the modified_timestamp
    # as Input and the data as State.
...
def add_new_day(
    n_clicks, storedCalendar, totalcal, totalprot, totalsugar, userinfo, lastmonth
):
    if n_clicks == 1:
        calpoints = (
            abs(totalcal - userinfo[2]) * 0.02
        )  # 100 calories difference = 2 points

        if totalprot - userinfo[3] >= 0:
            protpoints = 0  # If the user takes more protein we add no points.
        else:
            protpoints = (
                abs(totalprot - userinfo[3]) * 0.1
            )  # 10 proteins difference = 1 point

        if totalsugar - userinfo[4] <= 0:
            sugarpoints = 0  # If the user takes less sugar then we add 0 points
        else:
            sugarpoints = (
                totalsugar - userinfo[4]
            ) * 0.7  # High weight for sugar. It's important to be low.

        totalpoints = protpoints + calpoints + sugarpoints

        if (
            totalpoints <= 5
        ):  # Here we grade the "Day" based on the total points gathered.
            new_day = html.Div(
                [
                    dbc.Card(
                        [
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        [
                                            "Calories: " + str(round(totalcal, 1)),
                                            html.Br(),
                                            "Proteins: " + str(round(totalprot, 1)),
                                            html.Br(),
                                            "Sugars: " + str(round(totalsugar, 1)),
                                        ],
                                        className=("card-text"),
                                        style={
                                            "textAlign": "center",
        ...
        if lastmonth is not None:  # Check if user has at least one day in the calendar
            if lastmonth != today.strftime(
                "%m"
            ):  # If the last day was in a different month than today
                storedCalendar.append(html.Div(html.Hr()))
                storedCalendar.append(
                    html.H1([today.strftime("%B")], style={"textAlign": "center"})
                )
        else:
            storedCalendar.append(
                html.H1([today.strftime("%B")], style={"textAlign": "center"})
        ...
        return (
            html.Div(
                [
                    html.Div(storedCalendar, id="store-calendar-input"),
                    html.Div(
                        today.strftime("%m"),
                        id="lastmonth-input",  # When day is added, save the month
                        style={"display": "None"},
                    ),
                ]
            ),
...
@app.callback(
    Output("buttons-choice-output", "children"),
...
@app.callback(
    Output("output-image-myday", "children"), Input("upload-image-myday", "contents")
)
...
@app.callback(
    Output("myday-button-output", "children"),
    ...
    if value != "" and n_clicks < 2:
        ...
        new_consumed = html.Div(
            [
                ...
                # html.Div(value, id='totalgrams-input', style={'display':'None'} ),
                html.Div(
                    currentcal * value / 100 / 2,
                    id="day-total-cal-input",
                    style={"display": "None"},
                ),
                ...
                html.Div(
                    currentprot * value / 100 / 2,
                    id="day-total-prot-input",
                    style={"display": "None"},
                ),
                ...
                html.Div(
                    currentsugar * value / 100 / 2,
                    id="day-total-sugar-input",
                    style={"display": "None"},
                ),
...
@app.callback(
    Output("myday-button2-output", "children"),
            ...
            if (
                ...
                new_consumed = html.Div(
                    [
                        ...
                        html.H5(
                            ": " + str(value) + "g ", style={"display": "inline-block"}
                        ),
                        # html.Div(value, id='totalgrams-input', style={'display':'None'} ),
                        html.Div(
                            kcal * value / 100 / 2,
                            id="day-total-cal-input",
                            style={"display": "None"},
                        ),  # THIS COULD USE FIXING (/2 Because executed 2 times)
                        # html.Div(currentfat*value/100, id='total_fat-input', style={'display':'None'}),
                        # html.Div(currentsatfat*value/100, id='total_sat_fat-input', style={'display':'None'}),
                        html.Div(
                            proteins * value / 100 / 2,
                            id="day-total-prot-input",
                            style={"display": "None"},
                        ),
                        # html.Div(currentcarb*value/100, id='total_carb-input', style={'display':'None'}),
...
@app.callback(
    Output("today-products-value", "children"),
    # Since we use the data prop in an output,
    # we cannot get the initial data on load with the data prop.
    # To counter this, you can use the modified_timestamp
    # as Input and the data as State.
...
for store in ("cal", "prot", "sugar"):
    ...
    @app.callback(
        Output("day-total-{}".format(store), "data"),
    ...
    @app.callback(
        Output("day-total-{}-value".format(store), "children"),
        # Since we use the data prop in an output,
        # we cannot get the initial data on load with the data prop.
        # To counter this, you can use the modified_timestamp
        # as Input and the data as State.
