    ...
    if pathname == "/single": # THIS IS WHAT HAPPENS ON THE SINGLE PRODUCT PAGE
        ...
        return html.Div(
         ...
         return html.Div([
            ...
            html.H1("Many Products", style={'textAlign':'center', 'fontWeight':'bold'}),
            html.Hr(),html.Hr(),
            ...
            html.Hr(),
            dbc.Button('Calculate NutriScore', id='nutriscore-button', n_clicks = 0, style={'margin-left':'150px'}),
...
def displayClick(btn1, btn2):
    ...
    if 'button-nutvalue' in changed_id:
        msg = html.Div([
                ...
                html.Div([
                    dbc.Button('Add Product to Day', id='myday-button2', n_clicks=0, style={'margin-top':'40px'}),
                ], style={'textAlign':'center', 'margin-top':'40px'})
